                        ...
                        <div class="card-body">
                            ...
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                <div class="navi-item mb-2">
                                    <a href="{{route("edit_profile")}}" class="navi-link py-4 active">
                                        ...
                                        <span class="navi-text font-size-lg">Edit Profile</span>
                                    </a>
                                </div>
                            </div>
                            <!--end::Nav-->
                    ...
                    <div class="card card-custom  my-auto pt-4" id="account_info">
                        ...
                        <div class="card-header py-5" >
                            <div class="card-title w-100 justify-content-between">
                                    <div class="float-left">   <h3 class="card-label font-weight-bolder text-dark">Change Password</h3> </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="">
                                            <input class="form-control form-control-lg form-control-solid" type="password"  name="userPassword" />
                                        </div>
                                    </div>
                                </div>
                                 <div>
